                ...
                <Container>
                    <Row> 
                        ...
                        <Col xl={8} lg={8}>
                        {
                            ...
                            return(
                            <div key={ind}>
                            {item?.name === ActiveService &&
                                <>
                                    <div className="services__details-thumb mb-60">
                                        <img src="assets/images/services-details/sssmedia2.svg" alt=""/>
                                    </div>
...
const services = [
    { name: 'smm', title: 'SMM/SEO'},
    { name: 'digital', title: 'Digital Marketing' },
    { name: 'campaigns', title: 'Ad Campaigns' },
    { name: 'branding', title: 'Personal Branding' },
    { name: 'content', title: 'Content Creation' },
